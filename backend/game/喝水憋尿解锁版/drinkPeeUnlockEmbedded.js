const drinkPeeUnlock = {
  ...
  parameter: [
    ...
    { key: 'changeThreshold', type: 'number', name: '有效变化阈值(g/秒)', required: true, default: 1, min: 0, max: 5000, step: 0.1 },
    { key: 'stableWindowSec', type: 'number', name: '历史窗口(秒)', required: true, default: 30, min: 1, max: 600, step: 1 },
    ...
    { key: 'pressureThreshold', type: 'number', name: '气压阈值(Pa)', required: false, default: 20000, min: 0, max: 100000, step: 100 },
    { key: 'vibeStartProb', type: 'number', name: '振动启动概率(每秒)', required: false, default: 0.05, min: 0, max: 1, step: 0.01 },
    { key: 'vibeIntensity', type: 'number', name: '振动强度(0-100)', required: false, default: 60, min: 0, max: 100, step: 1 },
