<template>
  <div class="page">
    <div class="header-row">
      <div>
        <h1>玩法库</h1>
        <p class="muted">游戏与插件统一为「玩法」——选择一个配置并接入设备运行。</p>
      </div>
    ...
    <section class="toolbar-card">
      <div class="row">
        <el-input
          ...
          :prefix-icon="Search"
        />
        <el-button :icon="Upload" :loading="busy.upload" @click="triggerUpload">加载外部玩法</el-button>
    ...
    <el-empty v-if="!busy.refresh && filteredItems.length === 0" description="暂无玩法" />
