...
(function (root) {
  ...
  var M = {
    zh: {
      ...
      recH2: '推荐游戏',
      recLead: '精选玩法，完整列表在游戏页。',
      recAll: '查看全部 →',
      submitGuideH2: '游戏投稿说明',
      submitGuideLead: '不用 GitHub 也能投稿。复制 Prompt 让 AI 写游戏，上传 ZIP 或公开 Git 地址，审核通过后上架。',
      submitStep1Name: '用 AI 做游戏',
      submitStep1Desc: '复制 Prompt，交给 Claude Code / Codex 按开发规范实现',
      submitStep2Name: '打包并投稿',
      submitStep2Desc: '根目录含 index.html 与 game-manifest，打成 ZIP 或准备公开 Git 地址',
      submitStep3Name: '审核上架拿奖励',
      submitStep3Desc: '通过后玩家可直接玩；上架送硬件 + Token 套餐',
      submitTitle: '登录投稿 · 硅基之下游戏库',
      authEyebrow: '投稿工作台',
      authH1: '登录后提交游戏',
      authLead: '用邮箱账号登录，上传 ZIP 或填写公开 Git 地址。人工审核通过后发布到玩法库。',
      authPoint1: '与控制面板 App 同一套邮箱账号',
      authPoint2: 'ZIP 直传或提交公开 Git 地址',
      authPoint3: '人工审核，通过后自动上架',
      authPoint4: '上架后送硬件 + Token 套餐',
      authLogin: '登录',
      authRegister: '注册',
      authEmail: '邮箱',
      authPassword: '密码',
      ...
      authSameAccount: '使用与控制面板 App 相同的邮箱账号。',
      emailPh: 'you@example.com',
      passwordPh: '至少 8 位密码',
      dashSubmitH2: '提交游戏',
      dashSubmitLead: 'ZIP 根目录必须有 index.html 与 game-manifest。公开 Git 仓库根目录须满足相同结构。',
      dashMineH2: '我的投稿',
      dashMineLead: '审核进度与意见会显示在这里。',
      logout: '退出',
      adminLink: '审核后台',
      docsNav: '开发文档',
      docsStart: '快速开始',
      ...
      introParams: '可调参数',
      introSafety: '使用提醒',
      introSafetyBody: '请先确认设备连接正常，并在可随时停止的情况下开始。涉及刺激或锁定设备时，请预先确认安全边界，保持紧急停止方式可用。',
      introInfo: '游戏信息',
      introMissing: '未指定游戏',
      introNotFound: '游戏不存在',
      introNoDevices: '此玩法不需要额外设备。',
      introNoParams: '此玩法没有可调参数。',
      introHowToFallback: '打开游戏后按页面提示操作。',
      introGameId: '游戏 ID',
      introVersion: '版本',
      introSource: '来源',
      introSourceBuiltin: '官方内置',
      introSourceCommunity: '社区投稿',
      introSize: '体积',
      platformAuthor: '平台作者',
      unknownAuthor: '未知作者',
    },
    en: {
      ...
      recH2: 'Recommended',
      recLead: 'Featured plays. The full catalog is on the games page.',
      recAll: 'See all →',
      submitGuideH2: 'How to submit a game',
      submitGuideLead: 'No GitHub account needed. Copy the prompt for an AI, then upload a ZIP or a public Git URL. Approved games go live after review.',
      submitStep1Name: 'Build with AI',
      submitStep1Desc: 'Copy the prompt and let Claude Code / Codex follow the development guide',
      submitStep2Name: 'Pack and submit',
      submitStep2Desc: 'Root folder needs index.html and game-manifest. Upload a ZIP or a public Git URL',
      submitStep3Name: 'Review, ship, rewards',
      submitStep3Desc: 'Players can run it after approval. Listed games get hardware + Token packs',
      submitTitle: 'Sign in to submit · UnderSilicon Games',
      authEyebrow: 'Submission desk',
      authH1: 'Sign in to submit',
      authLead: 'Use your email account. Upload a ZIP or a public Git URL. Approved games are published to the library.',
      authPoint1: 'Same email account as the control panel app',
      authPoint2: 'Direct ZIP upload or a public Git URL',
      authPoint3: 'Manual review, then automatic listing',
      authPoint4: 'Listed games get hardware + Token packs',
      authLogin: 'Sign in',
      ...
      authSameAccount: 'Use the same email account as the control panel app.',
      emailPh: 'you@example.com',
      passwordPh: 'At least 8 characters',
      dashSubmitH2: 'Submit a game',
      dashSubmitLead: 'ZIP root must contain index.html and game-manifest. Public Git repos need the same layout.',
      dashMineH2: 'My submissions',
      dashMineLead: 'Review status and notes appear here.',
      logout: 'Sign out',
      adminLink: 'Moderation',
      docsNav: 'Docs',
      ...
      intro: 'Intro',
      introTitle: 'Game intro · UnderSilicon Games',
      introEyebrow: 'Game introduction',
      introAuthor: 'Author',
      introBack: 'Back to games',
      introNeed: 'What you need',
      introHow: 'How to play',
      introParams: 'Parameters',
      introSafety: 'Safety notes',
      introSafetyBody: 'Confirm devices are connected and that you can stop at any time. For shock or lock devices, set safety limits first and keep an emergency stop available.',
      introInfo: 'Game info',
      introMissing: 'No game specified',
      introNotFound: 'Game not found',
      introNoDevices: 'This play does not need extra devices.',
      introNoParams: 'This play has no tunable parameters.',
      introHowToFallback: 'Open the game and follow on-screen prompts.',
      introGameId: 'Game ID',
      introVersion: 'Version',
      introSource: 'Source',
      introSourceBuiltin: 'Official',
      introSourceCommunity: 'Community',
      introSize: 'Size',
