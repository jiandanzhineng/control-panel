...
(function (root) {
  ...
  var M = {
    zh: {
      ...
      navContribute: '投稿',
      footerNote: '硅基之下游戏库 · UnderSilicon 控制面板 · 已发布内容由平台审核后同步',
      footerNoteGames: 'UnderSilicon 控制面板 · 远程玩法仓库 · 已发布内容由平台审核后同步',
      footerNoteControl: 'UnderSilicon 控制面板 · 设备控制中心 · 已发布内容由平台审核后同步',
      footerDevices: '设备清单',
      ...
      contributeLead: '不用 GitHub 账号也能投稿。完成游戏后上传 ZIP，或填写公开 Git 地址；人工审核通过后，玩家会在控制面板里直接看到、直接玩。',
      tier1Name: 'AI 辅助开发',
      tier1Desc: '复制首页 Prompt，让 Claude Code / Codex 按开发规范实现',
      tier2Name: '上传投稿',
      tier2Desc: '上传 ZIP 或填写公开 Git 地址，进入人工审核',
      tier3Name: '投稿奖励',
    ...
    en: {
      ...
      footerNote: 'UnderSilicon Games · control panel · reviewed and published by the platform',
      footerNoteGames: 'UnderSilicon control panel · remote play registry · reviewed and published by the platform',
      footerNoteControl: 'UnderSilicon control panel · device console · reviewed and published by the platform',
      ...
      contributeLead: 'A GitHub account is not required. Upload a ZIP or submit a public Git URL; after review, players see the game in the control panel.',
      tier1Name: 'AI-assisted build',
      tier1Desc: 'Copy the home prompt and let Claude Code / Codex follow the development guide',
      tier2Name: 'Submit a game',
      tier2Desc: 'Upload a ZIP or provide a public Git URL for manual review',
      tier3Name: 'Rewards',
      tier3Desc: 'Approved listings get hardware + Token packs. Ask support for details',
      viewContribute: 'Submit a game →',
